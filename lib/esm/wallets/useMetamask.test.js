...
function render(provider) {
    var current = renderHook(function () { return useMetamask(provider); }).result.current;
    return current;
}
var uaGetter;
beforeEach(function () {
...
test('mobile device web2 browser on connect open deeplink', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        window.open = jest.fn();
        host = getHost();
        expectedLink = generateLink(host);
...
test('handle network change', function () {
    ...
    var provider = initMetamask();
    var result = renderHook(function () { return useMetamask(provider); }).result;
    ...
    function mockProvider() {
        return {
            ...
            setChainId: function updateChain(chainId) {
                var onNetworkChange = events[EthEvents.networkChange];
                if (onNetworkChange) {
