...
var useWalletConnect_1 = __importDefault(require("./useWalletConnect"));
...
function render(_a) {
    ...
    var current = (0, react_1.renderHook)(function () {
        return (0, useWalletConnect_1.default)({ setAccount: setAccountMock, signer: signer, account: account });
    }).result.current;
    return current;
}
beforeEach(function () {
...
test('return wallet id', function () {
    ...
    expect(walletId).toBe(types_1.WalletId.WalletConnect);
});
test('be available', function () {
...
test('call QR modal on connect', function () {
    ...
    expect(qrcode_modal_1.default.open).toBeCalled();
});
test('not call QR modal for already connected user', function () {
    ...
    expect(qrcode_modal_1.default.open).not.toBeCalled();
});
// TODO refactor
