...
function usePhantom() {
    var _this = this;
    var _a = (0, react_1.useState)(undefined), provider = _a[0], setProvider = _a[1];
    var _b = (0, react_1.useState)(null), account = _b[0], setAccount = _b[1];
    (0, react_1.useEffect)(function () {
        setProvider((0, utils_1.getProvider)());
    }, []);
            ...
            switch (_b.label) {
                case 0:
                    if (provider === undefined) {
                        throw new Error(strings_1.default.EXC_MSG_TRYING_TO_CONNECT_WHEN_PROVIDER_NOT_AVAILABLE);
                    }
    ...
    var sign = function (msg) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (provider === undefined) {
                        throw new Error(strings_1.default.EXC_MSG_TRYING_TO_SIGN_WHEN_PROVIDER_NOT_AVAILABLE);
                    }
