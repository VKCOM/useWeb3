...
function useMetamask(_provider) {
    var walletId = types_1.WalletId.Metamask;
    var isAvailable = isMetamaskAvailable();
    var _a = (0, react_1.useState)(), account = _a[0], setAccount = _a[1];
    var _b = (0, react_1.useState)(null), chainId = _b[0], setChainId = _b[1];
    ...
    (0, react_1.useEffect)(function () {
        if (provider) {
            ...
            provider.on(types_1.EthEvents.networkChange, setChainId);
        }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, provider.send(types_1.EthMethods.getAuthenticated, [])];
                case 1:
                    accounts = _a.sent();
...
function connect(provider, setAccount) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, provider.send(types_1.EthMethods.authenticate, [])];
                        case 1:
                            accountId = (_a.sent())[0];
                            if (setAccount)
    ...
    else if ((0, constants_1.isMobile)()) {
        window.open(generateLink((0, constants_1.getHost)()), '_blank');
    }
    return null;
}
...
function sign(provider) {
    if (provider) {
        ...
        return function signMessage(message) {
            return signer_1.signMessage(message);
        };
    }
    return null;
}
