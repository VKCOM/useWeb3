...
exports.signerFallbackFunction = void 0;
...
// TODO tests
var signerFallbackFunction = function (msg) {
    throw Error('Signer is not available, please init a connection to wallet first.');
};
exports.signerFallbackFunction = signerFallbackFunction;
function useWalletConnect(_a) {
    var _setAccount = _a.setAccount, _signer = _a.signer, _account = _a.account;
    var _b = (0, react_1.useState)(_account || null), account = _b[0], setAccount = _b[1];
    // TODO replace with useState
    var setNetworkMock = function (network) { };
    var _c = (0, react_1.useState)(null), signer = _c[0], setSigner = _c[1];
    var data = {
        walletId: types_1.WalletId.WalletConnect,
        isAvailable: true,
        account: account,
...
function sign(account, signMessage) {
    return function handleSign(message) {
        if (account && signMessage) {
            ...
            return (0, exports.signerFallbackFunction)([]);
        }
    };
}
